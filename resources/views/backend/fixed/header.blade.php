<body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <!-- Navbar Search-->
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" style="wide:20px">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown"> 
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="{{route('user.create')}}">User create</a></li>
                        @endif

                        @if(auth()->user()->user_type =='employee')
                        <li><a class="dropdown-item" href="{{route('employee.ptofile')}}">Employee profile</a></li>
                        @endif
